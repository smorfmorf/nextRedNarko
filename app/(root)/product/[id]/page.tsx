...
import { DragsImage } from "@/components/modal_and_product/Drags_Img";
import { DragsVariants } from "@/components/modal_and_product/Drags_variants";
  ...
  return (
    <Container className="flex flex-col my-10  ">
      <div className="flex flex-1">
        <DragsImage imageUrl={product.imageUrl} size={2} />
        <div className="w-[500px] bg-[#fcfcfc] p-8">
          ...
          <DragsVariants
            items={[
              { name: "Драг", value: 1, disabled: false },
              { name: "Опиаты", value: 2, disabled: false },
              { name: "Размешенная", value: 3, disabled: true },
            ]}
          />
        </div>
      </div>
